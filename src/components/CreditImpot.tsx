    ...
    <div className="min-h-screen text-gray-800 font-sans flex flex-col">
      ...
      <main className="flex-grow p-8 max-w-4xl mx-auto">
        ...
        <div className="rounded-3xl shadow-xl overflow-hidden transition-all bg-white border border-gray-200">
          ...
          {/* Bande 1 */}
          <div className="bg-gray-100 p-6 transition-colors duration-500">
            <p>
          ...
          {/* Bande 2 */}
          <div className="bg-white p-6 border-t transition-colors duration-500">
          ...
          {/* Bande finale bleue */}
          <div className="bg-blue-50 p-6 text-center border-t transition-colors duration-500">
            <p>
