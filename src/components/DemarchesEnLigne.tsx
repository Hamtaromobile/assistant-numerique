      ...
      <main className="p-4 md:p-8 max-w-4xl mx-auto w-full grow">
        ...
        <ScreenFrame>
          <section className="bg-gray-100 p-4 md:p-6 rounded-xl shadow-md mb-6 md:mb-8">
            <h2 className="text-xl md:text-2xl font-semibold mb-2">💻 Accompagnement numérique personnalisé</h2>
          ...
          <section className="bg-gray-100 p-4 md:p-6 rounded-xl shadow-md mb-6 md:mb-8">
            <h2 className="text-xl md:text-2xl font-semibold mb-2">📝 Création et suivi de dossiers</h2>
          ...
          <section className="bg-gray-100 p-4 md:p-6 rounded-xl shadow-md mb-6 md:mb-8">
            <h2 className="text-xl md:text-2xl font-semibold mb-2">🔐 Sécurité et confidentialité</h2>
