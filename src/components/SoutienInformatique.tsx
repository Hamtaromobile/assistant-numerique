      ...
      <main className="p-4 md:p-8 max-w-4xl mx-auto w-full grow">
        ...
        <ScreenFrame>
          <section className="bg-gray-100 p-4 md:p-6 rounded-xl shadow-md mb-6 md:mb-8">
            <h2 className="text-xl md:text-2xl font-semibold mb-2">💻 Accompagnement personnalisé</h2>

            {/* Mobile / tablette - version courte */}
            <p className="block md:hidden">
              Apprenez à mieux utiliser votre ordinateur, tablette ou smartphone, chez vous, à votre rythme.
            </p>
          ...
          <section className="bg-gray-100 p-4 md:p-6 rounded-xl shadow-md mb-6 md:mb-8">
            <h2 className="text-xl md:text-2xl font-semibold mb-2">📱 Simplicité & bienveillance</h2>
          ...
          <section className="bg-blue-50 p-4 md:p-6 rounded-xl shadow mt-6 md:mt-8 text-center">
            ...
            {/* Tarif et engagement (identique sur toutes tailles) */}
            ...
            {/* Mobile / tablette - bouton plus visible */}
            ...
            {/* Ordinateur - version lien dans phrase */}
